...
export default function Footer() {
    return (
        <>
            <footer className="bg-white rounded-lg shadow-sm dark:bg-gray-900" id="footer">
                <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8 font-serif">
                    ...
                    <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">ShintaDewi™</a>. All Rights Reserved.</span>
                </div>
            </footer>
        </>
    )
